...
CREATE TABLE `votacao` (
  ...
  `data_hora_votacao` datetime NOT NULL,
  `obj_votacao` varchar(256) NOT NULL,
  `proposicao_id` bigint(20) NOT NULL,
  `resumo` varchar(512) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FK26197B2B30614435` (`proposicao_id`),
  CONSTRAINT `FK26197B2B30614435` FOREIGN KEY (`proposicao_id`) REFERENCES `proposicao` (`id`)
